<?php
    ...
    global $SearchData;
    $SearchData = json_decode($_POST['Search'], true);
    ...
    class PDF extends FPDF{
        ...
        public function setData($val){
         ...
         function header(){
             ...
             $this->Ln();
             $this->SetFont('Times','',12);
             $this->Cell(276,10,'printed by: '. $Employee_FullName,0,0,'C');
             $this->Ln();
             $this->SetFont('Times','',12);
             $this->Cell(276,10, $Employee_ID,0,0,'C');
             $this->Ln(40);
         }
         ...
         function headerTable(){
             ...
             $this->Cell(40,10,'Search Results: '.$this->SearchData,0,0,'L');
             $this->Ln(20);
         ...
         function viewTable($data){
             ...
             $this->SetFont('Times','',12);
              for($i=0; $i<sizeof($data); $i++){
                ...
                $this->Cell(20,10,$data[$i][1],1,0,'C');
                $this->Cell(30,10,$data[$i][2],1,0,'C');
                $this->Cell(25,10,$data[$i][3],1,0,'C');
                $this->Cell(40,10,$data[$i][4],1,0,'C');
                $this->Cell(40,10,$data[$i][5],1,0,'C');
