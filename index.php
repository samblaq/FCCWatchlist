    ...
    if (isset($_POST['login'])) {
        ...
        if (empty($_POST['PWID']) || empty($_POST['password'])) {
            ...
            if ($matchFound == 1) {
                ...
                $error = "Incorrect Bank ID or password";
            }
        }
    }
?>
...
<head>
    ...
    <style type="text/css">
        ...
        body {
            background-image:url("assets/img/NHO.JPG");
...
<?php include("errorandsuccessmessages.php"); ?>
    ...
    <form method="POST" action="" id="form" style="font-family:Quicksand, sans-serif;background-color:rgba(44,40,52,0.73);width:320px;padding:40px; margin-top:50px;">
        <h4 id="head" style="color:rgb(0,159,218);">SCB FCC WATCHLIST</h4>
        <br>
        <div><img class="img-rounded img-responsive" src="assets/img/cropped-sc-touch-icon-192x192.png" id="image" style="width:auto;height:100px;"></div>
        <br>
